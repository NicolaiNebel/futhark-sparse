...
static void futrts_cli_entry_main(struct futhark_context *ctx)
{
    ...
    int time_runs;
    struct futhark_i32_1d *result_4102;
    ...
    if (perform_warmup) {
        ...
        r = futhark_entry_main(ctx, &result_4102);
        if (r != 0)
        ...
        assert(futhark_free_i32_1d(ctx, result_4102) == 0);
    }
    time_runs = 1;
    /* Proper run. */
    ...
    }
    {
        ...
        assert(arr != NULL);
        assert(futhark_values_i32_1d(ctx, result_4102, arr) == 0);
        write_array(stdout, binary_output, &i32_info, arr,
                    futhark_shape_i32_1d(ctx, result_4102), 1);
        free(arr);
    }
    printf("\n");
    assert(futhark_free_i32_1d(ctx, result_4102) == 0);
...
static bool static_array_realtype_4101[4] = {1, 0, 0, 1};
struct memblock {
    int *references;
    char *mem;
    int64_t size;
...
struct futhark_context {
    ...
    struct memblock static_array_4093;
} ;
struct futhark_context *futhark_context_new(struct futhark_context_config *cfg)
{
    ...
    ctx->static_array_4093 = (struct memblock) {NULL,
                                                (char *) static_array_realtype_4101,
                                                0};
    return ctx;
}
void futhark_context_free(struct futhark_context *ctx)
...
static int futrts_main(struct futhark_context *ctx,
                       int64_t *out_out_memsizze_4098,
                       struct memblock *out_mem_p_4099,
                       int32_t *out_out_arrsizze_4100);
...
static int futrts_main(struct futhark_context *ctx,
                       ...
                       int32_t *out_out_arrsizze_4100)
{
    int64_t out_memsizze_4091;
    struct memblock out_mem_4090;
    
    out_mem_4090.references = NULL;
    
    int32_t out_arrsizze_4092;
    struct memblock mem_4062;
    
    mem_4062.references = NULL;
    memblock_alloc(ctx, &mem_4062, 4, "mem_4062");
    
    struct memblock static_array_4093 = ctx->static_array_4093;
    
    memmove(mem_4062.mem + 0, static_array_4093.mem + 0, 4 * sizeof(bool));
    
    struct memblock mem_4065;
    
    mem_4065.references = NULL;
    memblock_alloc(ctx, &mem_4065, 16, "mem_4065");
    
    struct memblock mem_4068;
    
    mem_4068.references = NULL;
    memblock_alloc(ctx, &mem_4068, 16, "mem_4068");
    
    int32_t discard_4047;
    int32_t scanacc_4041 = 0;
    
    for (int32_t i_4044 = 0; i_4044 < 4; i_4044++) {
        bool x_4017 = *(bool *) &mem_4062.mem[i_4044];
        int32_t part_res_4018;
        ...
        int32_t zz_4016 = part_res_4019 + scanacc_4041;
        
        *(int32_t *) &mem_4065.mem[i_4044 * 4] = zz_4016;
        *(int32_t *) &mem_4068.mem[i_4044 * 4] = part_res_4018;
        
        int32_t scanacc_tmp_4094 = zz_4016;
        
        scanacc_4041 = scanacc_tmp_4094;
    }
    discard_4047 = scanacc_4041;
    memblock_unref(ctx, &mem_4062, "mem_4062");
    
    int32_t last_offset_4020 = *(int32_t *) &mem_4065.mem[12];
    int64_t binop_x_4078 = sext_i32_i64(last_offset_4020);
    int64_t bytes_4077 = 4 * binop_x_4078;
    struct memblock mem_4079;
    
    mem_4079.references = NULL;
    memblock_alloc(ctx, &mem_4079, bytes_4077, "mem_4079");
    for (int32_t write_iter_4048 = 0; write_iter_4048 < 4; write_iter_4048++) {
        int32_t write_iv_4050 = *(int32_t *) &mem_4068.mem[write_iter_4048 * 4];
        int32_t write_iv_4051 = *(int32_t *) &mem_4065.mem[write_iter_4048 * 4];
        bool is_this_one_4027 = write_iv_4050 == 0;
        int32_t this_offset_4028 = -1 + write_iv_4051;
        int32_t total_res_4029;
        
        if (is_this_one_4027) {
            total_res_4029 = this_offset_4028;
        } else {
            total_res_4029 = -1;
        }
        
        bool less_than_zzero_4054 = slt32(total_res_4029, 0);
        bool greater_than_sizze_4055 = sle32(last_offset_4020, total_res_4029);
        bool outside_bounds_dim_4056 = less_than_zzero_4054 ||
             greater_than_sizze_4055;
        
        if (!outside_bounds_dim_4056) {
            *(int32_t *) &mem_4079.mem[total_res_4029 * 4] = write_iter_4048;
        }
    }
    memblock_unref(ctx, &mem_4065, "mem_4065");
    memblock_unref(ctx, &mem_4068, "mem_4068");
    
    int32_t x_4030 = abs(last_offset_4020);
    bool empty_slice_4031 = x_4030 == 0;
    int32_t m_4032 = x_4030 - 1;
    bool zzero_leq_i_p_m_t_s_4033 = sle32(0, m_4032);
    bool i_p_m_t_s_leq_w_4034 = slt32(m_4032, last_offset_4020);
    bool y_4035 = zzero_leq_i_p_m_t_s_4033 && i_p_m_t_s_leq_w_4034;
    bool ok_or_empty_4036 = empty_slice_4031 || y_4035;
    bool index_certs_4037;
    
    if (!ok_or_empty_4036) {
        ctx->error = msgprintf("Error at %s:\n%s%s%s%d%s%d%s\n",
                               "dimModuleTest.fut:5:1-8:17 -> dimModuleTest.fut:7:35-7:72 -> /futlib/functional.fut:10:39-10:41 -> /futlib/soacs.fut:135:6-135:16",
                               "Index [", "", ":", last_offset_4020,
                               "] out of bounds for array of shape [",
                               last_offset_4020, "].");
        memblock_unref(ctx, &mem_4079, "mem_4079");
        memblock_unref(ctx, &mem_4068, "mem_4068");
        memblock_unref(ctx, &mem_4065, "mem_4065");
        memblock_unref(ctx, &mem_4062, "mem_4062");
        memblock_unref(ctx, &out_mem_4090, "out_mem_4090");
        return 1;
    }
    
    int64_t binop_x_4087 = sext_i32_i64(x_4030);
    int64_t bytes_4086 = 4 * binop_x_4087;
    struct memblock mem_4088;
    
    mem_4088.references = NULL;
    memblock_alloc(ctx, &mem_4088, bytes_4086, "mem_4088");
    memmove(mem_4088.mem + 0, mem_4079.mem + 0, x_4030 * sizeof(int32_t));
    memblock_unref(ctx, &mem_4079, "mem_4079");
    out_arrsizze_4092 = x_4030;
    out_memsizze_4091 = bytes_4086;
    memblock_set(ctx, &out_mem_4090, &mem_4088, "mem_4088");
    *out_out_memsizze_4098 = out_memsizze_4091;
    (*out_mem_p_4099).references = NULL;
    memblock_set(ctx, &*out_mem_p_4099, &out_mem_4090, "out_mem_4090");
    *out_out_arrsizze_4100 = out_arrsizze_4092;
    memblock_unref(ctx, &mem_4088, "mem_4088");
    memblock_unref(ctx, &mem_4079, "mem_4079");
    memblock_unref(ctx, &mem_4068, "mem_4068");
    memblock_unref(ctx, &mem_4065, "mem_4065");
    memblock_unref(ctx, &mem_4062, "mem_4062");
                       ...
                       struct futhark_i32_1d **out0)
{
    ...
    int ret = futrts_main(ctx, &out_memsizze_4091, &out_mem_4090,
                          &out_arrsizze_4092);
    
    if (ret == 0) {
        assert((*out0 = malloc(sizeof(struct futhark_i32_1d))) != NULL);
        (*out0)->mem = out_mem_4090;
        (*out0)->shape[0] = out_arrsizze_4092;
    }
    lock_unlock(&ctx->lock);
    return ret;
}
