...
-- input { [[1,2,3],[4,5,6],[7,8,9]] 0 0 100 }
-- output { [[100,2,3],[4,5,6],[7,8,9]] }
-- input { [[1,2,3],[4,5,6],[7,8,9]] 1 1 100 }
-- output { [[1,2,3],[4,100,6],[7,8,9]] }
-- input { [[1,2,3],[4,5,6],[7,8,9]] 2 2 100 }
-- output { [[1,2,3],[4,5,6],[7,8,100]] }
-- input { [[1,2,3],[4,5,6],[7,8,9]] 2 1 100 }
-- output { [[1,2,3],[4,5,6],[7,100,9]] }
